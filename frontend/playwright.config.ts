...
export default defineConfig({
  ...
  webServer: process.env.PLAYWRIGHT_BASE_URL
    ? undefined
    : {
        command: "npm run build && npx next start --hostname 127.0.0.1 --port 3400",
        url: `${baseURL}/smoke`,
        ...
        env: {
          ...
          NOTION_OAUTH_STATE_SECRET:
            process.env.NOTION_OAUTH_STATE_SECRET || "notion-state-secret",
          ...
          TRANSCRIPT_STORAGE_MODE:
            process.env.TRANSCRIPT_STORAGE_MODE || "disabled",
        },
      },
  projects: [
    {
